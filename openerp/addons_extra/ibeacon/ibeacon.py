...
class beacon(osv.osv):
    ...
    _columns = {'sample':fields.integer('sample',group_operator="max"),
                ...
                'x': fields.related('point_id', 'x', type='float',digits=(12,1), string='x', store=True, group_operator="avg"),
                'y': fields.related('point_id', 'y', type='float',digits=(12,1), string='y', store=True, group_operator="avg"),
                }
