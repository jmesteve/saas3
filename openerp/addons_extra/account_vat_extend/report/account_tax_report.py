...
class tax_report(report_sxw.rml_parse, common_report_header):
    _name = 'report.account.vat.declaration.extend'
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        self.display_no_movement = data['form']['display_no_movement']
        res['periods'] = ''
    ...
    def _get_lines(self, based_on, company_id=False, parent=False, level=0, context=None):
        ...
        while i < len(res):
            ...
            if not self.display_no_movement or tax_amount>0:
...
report_sxw.report_sxw('report.account.vat.declaration_extend', 'account.tax.code',
    'addons/account_vat_extend/report/account_tax_report.rml', parser=tax_report, header="internal")
